...
var dtable = $("#datatable").DataTable({
    ...
    {data: "tanggal_tagihan", "render": function ( data, type, row, meta ) {
    ...
    {data: "nominal_klaim", className : "dt-head-center dt-body-right bodyclick"},
    {data: "id_statusklaim", "render": function ( data, type, row, meta ) {
     if (data == 1) {
