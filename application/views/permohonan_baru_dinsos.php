...
<body class="vertical-layout vertical-menu 2-columns   menu-expanded fixed-navbar" data-open="click" data-menu="vertical-menu" data-col="2-columns">
          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="element mb-1 p-r-15">
                ...
                <a href="<?php echo base_url('Dinsos/excel_pengajuan_baru') ?>" class="btn btn-sm btn-success" style="border: none !important; border-radius: 10px;"><i class="ft-printer"></i> Export Excel</a>
              </div>
            </div>
          </div>
  ...
  <script>
    ...
    var dtable = $("#datatable").DataTable({
      ...
      columns: [{
        ...
        },
        {
          ...
          "render": function(data, type, row, meta) {
            ...
            var hapus = `<a href="<?php echo base_url('/Dinsos/hapus_permohonan_baru/'); ?>` + row.id_sjp + "/" + row.id_pengajuan +`" id="hapus" class="btn btn-danger btn-sm" onclick="return confirm('Apakah anda yakin akan menghapus pengajuan ini?');" i><i class="ft-trash"></i></a>`;
      ...
      ajax: {
        url: ' <?php echo base_url("Dinsos/getalldatapermohonan_dinsos"); ?>',
        method: 'POST',
        "data": function(d) {
