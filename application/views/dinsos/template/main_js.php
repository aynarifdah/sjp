<!-- BEGIN VENDOR JS-->
  ...
  <script src="<?php echo base_url()?>app-assets/vendors/js/pickers/daterange/daterangepicker.js"
  ...
  <!-- END MODERN JS-->
  <!-- BEGIN PAGE LEVEL JS-->
  <!--  <script src="<?php echo base_url()?>app-assets/js/scripts/pickers/dateTime/pick-a-datetime.js"
  type="text/javascript"></script> -->
  <!-- END PAGE LEVEL JS-->
  <!-- data table-->
  ...
  <script src="<?php echo base_url()?>app-assets/vendors/js/pickers/dateTime/moment-with-locales.min.js"
  type="text/javascript"></script>
  <script src="<?php echo base_url()?>app-assets/vendors/js/pickers/daterange/daterangepicker.js"
  type="text/javascript"></script>
  <script src="<?php echo base_url()?>app-assets/vendors/js/forms/validation/jquery.validate.min.js"
  type="text/javascript"></script>
  <!-- END PAGE VENDOR JS-->
  <!-- BEGIN MODERN JS-->
  <script src="<?php echo base_url()?>app-assets/js/core/app-menu.js" type="text/javascript"></script>
