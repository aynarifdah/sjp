    ...
    <div class="col-12">
      ...
      <div class="card">
        ...
        <div class="card-header">
          <h4 class="card-title">Edit Waktu Pengajuan</h4>
        ...
        <div class="card-content collapse show">
          <div class="card-body">
            <form action="<?= base_url('Dinkes/update_parameter_waktu') ?>" method="POST" class="wpcf7-form sjpform" id="sjpform" enctype="multipart/form-data">
              <?php foreach ($waktu as $key): ?>
                ...
                <fieldset class="mt-2">
                  <div class="form-group row">
                    ...
                    <div class="col-lg-3">
                      <input type="time" class="form-control" placeholder="Waktu Buka" name="waktu_buka" id="waktu_buka" required value="<?= $key['waktu_buka'] ?>">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label class="col-lg-3 label-control" for="waktu_tutup">Waktu Tutup</label>
                    <div class="col-lg-3">
                      <input type="time" class="form-control" placeholder="Waktu Tutup" name="waktu_tutup" id="waktu_tutup" required value="<?= $key['waktu_tutup'] ?>">
                    </div>
                  </div>
