<section id="portfolio" class="portfolio">
              ...
              <div class="form-group row">
                ...
                <div class="col-lg-6" style="padding: 0px 15px 5px 15px;">
                  ...
                  <button type="submit" class="btn btn-primary btn-md" name="button"
                    style="margin-left: 108%;">Cari</button>
                </div>
              </div>
            </form>
                ...
                <table id="datatable" class="table table-bordered" style="width: 100%; ">
                  <thead>
                    <tr>
                      ...
                      <th style="background: #fff !important; color: #6B6F82!important; text-align:  left !important;">
                        Pemohon</th>
                      <th style="background: #fff !important; color: #6B6F82!important; text-align:  left !important;">
                        Pasien</th>
                      <th style="background: #fff !important; color: #6B6F82!important; text-align:  left !important;">
  ...
  <script src="<?= base_url()?>app-assets/js/scripts/tables/datatables/datatable-basic.js" type="text/javascript">
  </script>
        ...
        },
        {
          ...
          "render": function (data, type, row, meta) {
            if (data == 1) {
              ...
              return '<div class="badge bg-blue-grey " style="font-size: 14px;">' + row.status_pengajuan +
                '</div>'
              ...
              // return row.status_pengajuan;
              return '<div class="badge bg-primary " style="font-size: 14px;">' + row.status_pengajuan +
                '</div>'
            } else if (data == 4) {
              // $('.statuspengajuan').addClass('bg-success');
              // return row.status_pengajuan;
              return '<div class="badge bg-warning " style="font-size: 14px;">' + row.status_pengajuan +
                '</div>'
            } else if (data == 5) {
              // $('.statuspengajuan').addClass('bg-success');
              // return row.status_pengajuan;
              ...
              // $('.statuspengajuan').addClass('bg-success');
              // return row.status_pengajuan;
              return '<div class="badge bg-success " style="font-size: 14px;">' + row.status_pengajuan +
                '</div>'
            } else if (data == 7) {
              // $('.statuspengajuan').addClass('bg-success');
              // return row.status_pengajuan;
