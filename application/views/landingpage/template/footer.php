    ...
    <div class="container">
      <div class="row gy-4">
        <div class="col-lg-5 col-md-5 footer-info">
          ...
          <h4>Sistem Jaminan Pelayanan Bagi Masyarakat kurang Mampu Yang Handal Dari Segi Kualitas Data, Fitur Yang
            Disediakan, dan Penyajian Informasi Kota Depok</h4>
          <p>Memberikan layanan bagi masyarakat yang kurang mampu, sakit, Membutuhkan biaya dan perlu akses Layanan yang
            mudah.</p>
