  ...
  <script src="<?php echo base_url('assets-web/splide/js/splide.min.js') ?>"></script>
    ...
    <!-- hightchart -->
    <script src="asset-web('https://code.highcharts.com/highcharts.js"></script>
    <script src="asset-web('https://code.highcharts.com/modules/series-label.js"></script>
    <script src="asset-web('https://code.highcharts.com/modules/exporting.js"></script>
    <script src="asset-web('https://code.highcharts.com/modules/export-data.js"></script>
    <script src="asset-web('https://code.highcharts.com/modules/accessibility.js"></script>
