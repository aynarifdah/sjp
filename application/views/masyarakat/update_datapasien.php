  ...
  <div class="row">
    <div class="col-12">
      ...
      <div class="card">
        ...
        <div class="card-content collapse show">
          <div class="card-body">
            <form action="<?= base_url('masyarakat/detail_pengajuan/'.$detail[0]['id_sjp'].'/'.$id_pengajuan); ?>" method="POST" class="wpcf7-form sjpform" id="sjpform">
              ...
              <select id="" name="jenis_kelamin_pemohon" class="form-control" required >
                ...
                <div class="form-group row" id="modalwal">
                  ...
                  <div class="col-lg-3">
                    ...
                    name="status_hubungan" id="status_hubungan" required value="<?= $detail[0]['status_hubungan'] ?>">
                  </div>
                </div> 
                <div class="form-group row">
        ...
        <fieldset class="mt-2">
          <div class="form-group row">
            ...
            <div class="col-lg-3">
              ...
              name="nikpasien" id="nikpasien" required value="<?= $detail[0]['nik'] ?>">
            </div>
          </div>
          <div class="form-group row">
            <label class="col-lg-3 label-control" for="namalengkap">Nama Lengkap</label>
            ...
            <div class="col-lg-3" style="padding: 0px 15px 5px 15px;">
              <select id="" name="jenis_kelamin_pasien" class="form-control" required>
                <option value="">Jenis Kelamin</option>
          ...
          <div class="form-group row">
            ...
            <div class="col-lg-3" style="padding: 0px 15px 5px 15px;">
              <select class="select2 form-control block" id="golongandarah" name="golongan_darah_pasien" style="width: 100%" value="<?= $detail[0]['golongan_darah'] ?>">
                <option value="">Golongan Darah</option>
                <option value="A"  <?= ($detail[0]['golongan_darah'] == 'A')? 'selected' : '' ?> >A</option>
                <option value="B"  <?= ($detail[0]['golongan_darah'] == 'B')? 'selected' : '' ?> >B</option>
                <option value="AB" <?= ($detail[0]['golongan_darah'] == 'AB')? 'selected' : '' ?> >AB</option>
                <option value="O"  <?= ($detail[0]['golongan_darah'] == 'O')? 'selected' : '' ?> >O</option>
              </select>
            </div>
          </div>
          <div class="form-group row">
          ...
          <div class="col-lg-3" style="padding: 0px 15px 5px 15px;">                        
            <select name="nama_rumah_sakit" id="nama_rumahsakit" class="select2 form-control" required>
             ...
             <?php if (!empty($rumahsakit)) {
              ...
              <option value="<?= $key['id_rumah_sakit'] ?>" <?= ($key['id_rumah_sakit']== $detail[0]["id_rumah_sakit"])? 'selected' : '' ?> ><?= $key['nama_rumah_sakit'] ?></option>
              <?php }
            } ?> 
          </select>
        </div>
        <div class="col-lg-3" style="padding: 0px 15px 5px 15px;"> 
          <select name="jenis_rawat" id="jenisrawat" class="form-control" style="width: 100%" required value="<?= $detail[0]['jenis_rawat'] ?>">
        ...
        <div class="col-lg-3" style="padding: 0px 15px 5px 15px;">                        
          <input type="date" class="form-control" placeholder="Tanggal Mulai Rawat" name="mulairawat" id="mulairawat" value="<?= $detail[0]['mulai_rawat'] ?>">
        </div>
        <div class="col-lg-3" style="padding: 0px 15px 5px 15px;">                        
          <input type="date" class="form-control" placeholder="Tanggal Akhir Rawat" name="akhirrawat" id="selesairawat" value="<?= $detail[0]['selesai_rawat'] ?>">
        </div>
      </div>
