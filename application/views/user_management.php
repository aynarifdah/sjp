            ...
            <div class="modal-body">
              <div class="form-group row">
                ...
                <div class="col-lg-9">
                  ...
                  <input type="text" class="form-control" placeholder="Nama Level" name="level" id="level" required>
                </div>
              </div>
            ...
            <div class="modal-body">
              <div class="form-group row">
                ...
                <div class="col-lg-9">
                  ...
                  <input type="text" class="form-control" placeholder="Nama Instansi" name="instansi" id="instansi" required>
                </div>
              </div>
              <button type="button" class="btn-sm btn grey" data-dismiss="modal">Batal</button>
