...
<script src="<?php echo base_url()?>app-assets/vendors/js/charts/jvector/jquery-jvectormap-2.0.3.min.js"
...
<div class="row">
   ...
   <div class="col-12 col-md-4 col-sm-6">
            <div class="card">
              ...
              </div>              <div class="card-content collapse show" style="padding: 10px; min-height: 440px;">
...
<script>
  ...
  $("#orderDistribusi").change(function() {
    ...
    $.ajax({
      ...
      method: "POST",
      data: { bulan: bulan, tahun: tahun, kecamatan: kecamatan, kelurahan:kelurahan, orderDistribusi: orderDistribusi },
