  ...
  <div class="main-menu-content">
    <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
      ...
      <li class=" nav-item"><a href="<?php echo base_url('Dinkes/persetujuan_sjp_kayankesru');?>"><i class="ft-check-square"></i><span class="menu-title" data-i18n="nav.support_raise_support.main">Persetujuan SJP</span></a>
         ...
         <!-- <li class=" nav-item"><a href="#"><i class="la la-television"></i><span class="menu-title" data-i18n="nav.templates.main">Persetujuan SJP</span></a>
          <ul class="menu-content">
            <li><a class="menu-item" href="<?php echo base_url('Home/pengajuan_sjp');?>" data-i18n="nav.templates.horz.main">Pengajuan SJP</a></li>
          </ul>
        </li> -->
        <li class=" nav-item"><a href="#"><i class="ft-credit-card"></i><span class="menu-title" data-i18n="nav.page_headers.main">Proses Klaim</span></a>
          <ul class="menu-content">
            <li><a href="<?php echo base_url('Dinkes/pengajuan_klaim');?>" class="menu-item">Semua Klaim</a>
              ...
              <!-- <li><a href="<?php echo base_url('Dinkes/daftar_pembiayaan');?>" class="menu-item">Cetak Daftar Pembiayaan</a>
              </li>  --> 
            </li>  
          </ul>
        </li>
        <li class=" nav-item"><a href="#"><i class="ft-printer"></i><span class="menu-title" data-i18n="nav.page_headers.main">Laporan Rekapitulasi</span></a>
          <ul class="menu-content">
              <!-- <li><a href="<?php echo base_url('Home/rekapitulasi_sjp');?>" class="menu-item">Rekapitulasi SJP</a>
              </li> -->
          ...
          <!-- <li class=" nav-item"><a href="<?php echo base_url('Home/parameter');?>"><i class="la la-cog"></i><span class="menu-title" data-i18n="nav.support_raise_support.main">Parameter</span></a>
          </li> -->
        </ul>
      </div>
    </div>