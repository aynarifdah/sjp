            ...
            <form action="<?php echo base_url('Home/input_pasien'); ?>" method="POST" enctype="multipart/form-data" class="wpcf7-form sjpform" id="sjpform">
              ...
              <fieldset class="mt-2">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-lg-1" style="padding: 0px 15px 5px 15px;">
                    <input type="text" class="form-control" placeholder="Rw" name="rw_pemohon" id="rwpemohon" required>
                  </div>
                </div>
                <div class="form-group row">
              ...
              <fieldset class="mt-2">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-lg-3" style="padding: 0px 15px 5px 15px;">
                    <input type="text" class="form-control" placeholder="Tempat Lahir" name="tempat_lahir" id="tempatlahirpasien" required>
                  </div>
                  <div class="col-lg-3" style="padding: 0px 15px 5px 15px;">
                    <input type="text" class="form-control" placeholder="Tanggal Lahir" name="tanggal_lahir" id="tanggallahirpasien" data-toggle="daterangepicker" data-filter-type="date-range" required>
                  </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-lg-6" style="padding: 0px 15px 5px 15px;">
                    <input type="text" class="form-control" placeholder="Alamat" name="alamat_pasien" id="alamatpasien" required value="<?= set_value('alamat_pasien'); ?>">
                  ...
                  <div class="col-lg-1  " style="padding: 0px 15px 5px 15px;">
                    <input type="text" class="form-control" placeholder="Rw" name="rw_pasien" id="rwpasien" required>
                  </div>
                </div>
                <div class="form-group row">
                  <label class="col-lg-3 label-control" for="tempat">Kecamatan*/Kelurahan*</label>
                ...
                <div class="form-group row">
                  <label class="col-lg-3 label-control" for="notelp">Rumah Sakit/ Jenis Rawat*</label>
                  <div class="col-lg-3" style="padding: 0px 15px 5px 15px;">
                ...
                <?php if (!empty($dokumen)) {
                  foreach ($dokumen as $key) { ?>
                    <div class="form-group row" id="modalwal">
                      <label class="col-lg-3 label-control" for="modal">
                        <?php
                          if ($key["id_persyaratan"] == 2 || $key["id_persyaratan"] == 5 || $key["id_persyaratan"] == 4) {
                              echo $key['nama_persyaratan'] . ' *';
                          } else {
                              echo $key['nama_persyaratan'];
                          }
                        ?>
