                ...
                <?php if (!empty($dokumen)) {
                  foreach ($dokumen as $key) { ?>
                    <div class="form-group row" id="modalwal">
                      ...
                      <div class="col-lg-9">
                        <?php if ($key["id_persyaratan"] == 6 || $key["id_persyaratan"] == 7 && 8 || $key["id_persyaratan"] == 10  && 8 || $key["id_persyaratan"] == 3 && 11 || $key["id_persyaratan"] == 11 && 12 || $key["id_persyaratan"] == 12 && 13 || $key["id_persyaratan"] == 13 && 14 || $key["id_persyaratan"] == 14 || $key["id_persyaratan"] == 20 && 21) { ?>
