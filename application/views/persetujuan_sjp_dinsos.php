          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="element mb-1 p-r-15">
                ...
                <a href="<?php echo base_url('Dinsos/excel_data_persetujuan') ?>" class="btn btn-sm btn-success" style="border: none !important; border-radius: 10px;"><i class="ft-printer"></i> Export Excel</a>
              </div>
            </div>
          </div>
