    ...
    <div class="col-12">
      ...
      <div class="card">
        ...
        <div class="card-header">
          <h4 class="card-title">Pengajuan Data Pasien</h4>
              ...
              <?php if ($this->session->userdata('instansi') == 6) { ?>
                ...
                <fieldset class="mt-2">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-lg-3">
                      <select name="domisili" id="domisili" name="domisili" class="form-control" readonly>
                  ...
                  <div class="form-group row">
                    <label class="col-lg-3 label-control" for="namalengkap">Nama Lengkap</label>
                    <div class="col-lg-3" style="padding: 0px 15px 5px 15px;">
                      <input type="text" class="form-control kontrakform" placeholder="Nama Lengkap" name="nama_pasien" id="namapasien" required value="<?= $detail[0]['nama_pasien'] ?>" readonly>
                    </div>
                    <div class="col-lg-3" style="padding: 0px 15px 5px 15px;">
                      <select name="jenis_kelamin_pasien" id="" name="jenis_kelamin_pasien" class="form-control" required readonly>
                        <option value="">Jenis Kelamin</option>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-lg-3" style="padding: 0px 15px 5px 15px;">
                      <input type="text" class="form-control" placeholder="Tempat Lahir" name="tempat_lahir_pasien" id="tempatlahirpasien" required value="<?= $detail[0]['tempat_lahir'] ?>" readonly>
                    </div>
                    <div class="col-lg-3" style="padding: 0px 15px 5px 15px;">
                      <?php
                      ...
                      ?>
                      <input type="text" class="form-control datepicker" placeholder="Tanggal Lahir" name="tanggal_lahir_pasien" id="tanggallahirpasien" required value="<?= $new_date ?>" readonly>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label class="col-lg-3 label-control" for="tempat">Pekerjaan/ Gol Darah</label>
                    <div class="col-lg-3" style="padding: 0px 15px 5px 15px;">
                      <input type="text" class="form-control" placeholder="Pekerjaan" name="pekerjaanpasien" id="pekerjaanpasien" required value="<?= $detail[0]['pekerjaan'] ?>" readonly>
                    </div>
                    <div class="col-lg-3" style="padding: 0px 15px 5px 15px;">
                      <select class="select2 form-control block" id="golongandarah" name="golongan_darah_pasien" style="width: 100%" readonly>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-lg-6" style="padding: 0px 15px 5px 15px;">
                      <input type="text" class="form-control" placeholder="Alamat" name="alamatpasien" id="alamatpasien" required value="<?= $detail[0]['alamat'] ?>" readonly>
                    </div>
                    <div class="col-lg-1" style="padding: 0px 15px 5px 15px;">
                      <input type="text" class="form-control" placeholder="Rt" name="rtpasien" id="rtpasien" required value="<?= $detail[0]['rt'] ?>" readonly>
                    </div>
                    <div class="col-lg-1" style="padding: 0px 15px 5px 15px;">
                      <input type="text" class="form-control" placeholder="Rw" name="rwpasien" id="rwpasien" required value="<?= $detail[0]['rw'] ?>" readonly>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label class="col-lg-3 label-control" for="tempat">Kec/Kel</label>
                    ...
                    <div class="col-lg-3" style="padding: 0px 15px 5px 15px;">
                      <select class="select2 form-control block kecamatan" id="kd_kecamatanpasien" name="kd_kecamatanpasien" style="width: 100%" readonly>
                        <option>Pilih Kecamatan</option>
                    ...
                    <div class="col-lg-3" style="padding: 0px 15px 5px 15px;">
                      <select class="select2 form-control block kelurahan" id="kd_kelurahanpasien" name="kd_kelurahanpasien" style="width: 100%" readonly>
                        <option>Pilih Kelurahan</option>
                      </select>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label class="col-lg-3 label-control" for="notelp">Informasi Kontak</label>
                    <div class="col-lg-2" style="padding: 0px 15px 5px 15px;">
                      <input type="text" class="form-control" placeholder="No Telp" name="teleponpasien" id="teleponpasien" value="<?= $detail[0]['telepon'] ?>" readonly>
                    </div>
                    <div class="col-lg-2" style="padding: 0px 15px 5px 15px;">
                      <input type="text" class="form-control" placeholder="No Whatsapp" name="whatsappasien" id="whatsapppasien" value="<?= $detail[0]['whatsapp'] ?>" readonly>
                    </div>
                    <div class="col-lg-5" style="padding: 0px 15px 5px 15px;">
                      <input type="email" class="form-control" placeholder="Email" name="emailpasien" id="emailpasien" value="<?= $detail[0]['email'] ?>" readonly>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-lg-3" style="padding: 0px 15px 5px 15px;">
                      <select name="nama_rumah_sakit" id="nama_rumahsakit" class="select2 form-control" required style="width: 100%" readonly>
                    ...
                    <div class="col-lg-3" style="padding: 0px 15px 5px 15px;">
                      <select name="jenis_rawat" id="jenisrawat" class="form-control" style="width: 100%" required readonly>
                    ...
                    <div class="col-lg-3" style="padding: 0px 15px 5px 15px;">
                      <select name="kelas_rawat" id="kelas_rawat" class="form-control" style="width: 100%" readonly>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-lg-3" style="padding: 0px 15px 5px 15px;">
                      ...
                      ?>
                      <input type="text" class="form-control datepicker" placeholder="Tanggal Mulai Rawat" name="mulairawat" id="mulairawat" required value="<?= $new_mulai_rawat ?>" readonly>
                    </div>
                    <div class="col-lg-3" style="padding: 0px 15px 5px 15px;">
                      <?php
                      ...
                      ?>
                      <input type="text" class="form-control datepicker" placeholder="Tanggal Akhir Rawat" name="akhirrawat" id="akhirrawat" required value="<?= $new_selesai_rawat ?>" readonly>
                    </div>
                        ...
                        <div class="input-group mb-1 diagnosapenyakit" data-repeater-item="">
                          ...
                          <div class="row" style="width: 100%;">
                            ...
                            <div class="col-lg-12 diagnosalainnya mt-1">
                              <input type="text" class="form-control" placeholder="Masukkan Diagnosa Lainnya" name="diagnosalainnya" value="<?= $testDiagnosa[0]['id_penyakit']; ?>" readonly>
                            </div>
                          </div>
                        </div>
