...
class Kelurahan extends CI_Controller
{
    ...
    function setujuiSurvey($id_sjp)
    {
        ...
        redirect('Kelurahan/detail_pengajuan', 'refresh');
    }
    ...
    public function getIdKelurahan($kelurahan_id)
    {
        $id_kelurahan = $this->M_SJP->getByKelurahanId($kelurahan_id);
        return $id_kelurahan;
    }
    ...
    public function input_pasien()
    {
        ...
        redirect(site_url('Kelurahan/permohonan_baru'));
