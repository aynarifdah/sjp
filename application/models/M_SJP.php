...
class M_SJP extends CI_Model
{
  ...
  function select_pengajuan_sjp_all($limit = null, $puskesmas = Null, $rumahsakit = Null, $status = Null, $cari = Null, $mulai = Null, $akhir = null, $jaminan = null, $status_jkn = null, $offset = 0)
  {
